...
![IMG 1](screenshot/soal.png)

## Struktur Package & Module

![IMG 2](screenshot/2.png)

- Di dalam folder/package model terdapat 1 file dengan nama daftar nilai. Di dalam file tersebut telah terdapat beberapa function yang dibuat untuk menjalankan program tersebut.<br>
...
- Setelah membuat banyak folder/package dan function, saya membuat file utamanya. Yang saya beri nama _main.py_. Berikut isi dari file tersebut :<br>
